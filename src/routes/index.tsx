...
const AddSingleSchedule = Loadable(lazy(() => import('../pages/customPages/schedule/AddSingleSchedule')));
...
const AddMultiplePriceConfig = Loadable(lazy(() => import('../pages/customPages/prices/priceConfig/AddMultiplePriceConfig')));